...
def getLatestLintPostURLForLanguage(lang="de"):
    ...
    """
    page_source = fetchSelenium("https://groups.google.com/a/khanacademy.org/forum/#!forum/i18n-reports")
...
def getLatestLintDownloadLinks(lang="de"):
...
if __name__ == "__main__":
    ...
    #print(url)
    print(getLatestLintDownloadLinks())
