...
rules = [
    ...
    DynamicTranslationIdentityRule("Thousands separation via {,} (must be {\\,}) (experimental)", r"(\d+\{,\}\d+\{,\}\d+(\{,\}\d+)*)", group=0, severity=Severity.dangerous), #Should be space. Comma without {} ignored.
