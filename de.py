...
rules = [
    ...
    NegativeTranslationConstraintRule("'Post' translated to 'Post' instead of 'Beitrag'", r"\bpost\s*(?!card)(?!man)(?!office)", r"\bpost(?!karte)(?!amt)(?!en)(?!e)", flags=re.UNICODE | re.IGNORECASE),
