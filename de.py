...
rules = [
    ...
    IgnoreByFilenameListWrapper(["de/4_low_priority/about.team.pot"], SimpleRegexRule("Occurrence of untranslated 'school'", r"(?<!Old-)(?<!High[- ])\b[S]chool\b")),
    ...
    NegativeTranslationConstraintRule("'Post' translated to 'Post' instead of 'Beitrag'", r"post(?!card)", r"post(?!karte)(?!amt)", flags=re.UNICODE | re.IGNORECASE),
