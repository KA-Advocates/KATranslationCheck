...
rules = [
    ...
    TranslationConstraintRule("'Triangle' not translated to 'Dreieck'", r"(?<!\\)triangle", r"Dreieck", severity=Severity.info, flags=re.UNICODE | re.IGNORECASE),
    TranslationConstraintRule("'Quadrilateral' not translated to 'Viereck'", r"Quadrilateral", r"Viereck", severity=Severity.info, flags=re.UNICODE | re.IGNORECASE),
