...
rules = [
    ...
    NegativeTranslationConstraintRule("'Post' translated to 'Post' instead of 'Beitrag'", r"\bpost\s*(?!card)(?!office)", r"\bpost(?!karte)(?!amt)(?!en)", flags=re.UNICODE | re.IGNORECASE),
