...
rules = [
    ...
    IgnoreByMsgidRegexWrapper(r"[Pp]ost\s*(office|card|alCode|man|-Money)",
        NegativeTranslationConstraintRule("'Post' translated to 'Post' instead of 'Beitrag'", r"\bpost", r"\bpost(?!karte)(?!amt)(?!ulat)(?!ulate)(?!en)(?!e)", severity=Severity.info, flags=re.UNICODE | re.IGNORECASE)),
