...
rules = [
    ...
    TranslationConstraintRule("'Triangle' not translated to 'Dreieck'", r"(?<!\\)triangle", r"Dreieck", severity=Severity.infos, flags=re.UNICODE | re.IGNORECASE),
    TranslationConstraintRule("'Quadrilateral' not translated to 'Viereck'", r"Quadrilateral", r"Viereck", severity=Severity.infos, flags=re.UNICODE | re.IGNORECASE),
